...
driver = webdriver.Chrome(r"C:\Users\82103\Downloads\chromedriver_win32\chromedriver.exe")
...
def main():
    global driver, load_wb, review_num,place
    ...
    driver.quit()
    print("finish")
    print(review_dict['아콘스톨'])

def search(place):
    global driver,review_dict
    review_dict = {place:[]}
        ...
        for i, review in enumerate(review_lists):
            ...
            if len(comment) != 0:
                if len(rating) != 0:
                    ...
                    val2= [comment[0].text,rating[0].text]
                    
                    
                else:
                    val = comment[0].text + '/0'
                    val2= [comment[0].text,"0"]
                    
                print(val)
                review_dict[place].append(val2)
